...
export default function ChatSideBar(props: ChatSideBarProps) {
  ...
  return (  
    ...
    <aside className={`lg:w-1/5 sm:w-[70%] bg-[#dafdc0] p-4  xsm:w-[80%] w-[90%]  h-screen fixed left-0 mx-0 overflow-y-auto  ${selector.open ?"scale-100":"scale-0"} transition-all duration-500 ease-in-out origin-top-left z-10 overflow-hidden lg:scale-100`}>
        <div className="mt-16">
