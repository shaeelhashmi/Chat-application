...
export default function ToolTipbtn(props:ToolTipProps) {
  ...
  return (
<div className={`group relative   w-fit sm:text-base text-sm text-white hover:bg-white/10  hover:rounded-full sm:p-2 p-1 duration-500 transition-all ${selector==props.link?"bg-white/10  rounded-full":""}`}>
