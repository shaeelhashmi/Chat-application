...
export default function WarningBox(props:{popup:boolean
  ...
  return (
    <div
      className={`fixed transform -translate-x-1/2 -translate-y-1/2 bg-[#040404] shadow-lg rounded-lg p-6 flex items-center justify-center flex-col gap-4 z-50 sm:w-[400px] w-[300px] h-[300px] sm:h-[400px] transition-all duration-500 ease-out
